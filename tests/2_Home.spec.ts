...

{
    ...
    await test.step("Check if the info/credits text is visible & check the text", async () => {
        ...
        await expect(home.InfoMessage).toHaveText("This page is for automation testing purposes only. All credits for making the base of this page direct to: https://github.com/daniel-jebarson.");
    });
